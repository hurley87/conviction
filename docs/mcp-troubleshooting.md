...
| Doctor tool discovery fail | Rebuild `@conviction/mcp`; confirm `LIVE_TOOLS` length 10. |
...
| Host missing tools | Ensure config pins `@conviction/mcp@1` and uses the shared runner. |

...
Generated MCP host configurations invoke `@getconviction/mcp@1`, or an equivalent installation pinned to major version 1. They may receive compatible minor and patch releases within v1, but they never automatically cross a major-version boundary.
...
- Generated package-runner snippets use a major pin such as `@getconviction/mcp@1`.

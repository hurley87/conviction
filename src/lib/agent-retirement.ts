...
import {
  acceptedRetirementLegFinality,
  emptyRetirementLegFinality,
  MAX_RETIREMENT_FINALITY_ATTEMPTS,
  reconcileRetirementLegFinality,
  updateLegInRecord,
  type RetirementLegFinality,
} from "@/lib/agent-retirement-finality";
...
export function isTerminalLegStatus(status: RetirementLegStatus): boolean {
